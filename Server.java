	...
	public void PublicServer() {
		...
		while(flag) {
			...
			case 1:
				...
				Casher.insertCustomer(ID, Name, Address, Sex, Birthdate);
				Casher.InsertOrder(Order_No, Book_Number, eSSN,Book_Number);
				Casher.InsertReceipt(Order_No, Order_No, eSSN, Book_Number);
                                Casher.quantityMinus(Book_Number);
				System.out.println("-----------------------");
